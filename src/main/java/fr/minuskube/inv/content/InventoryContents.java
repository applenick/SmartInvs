...
public interface InventoryContents {
  ...
  InventoryContents fillRect(
      int fromRow, int fromColumn, int toRow, int toColumn, ClickableItem item);
  ...
  class Impl implements InventoryContents {
    ...
    public SlotIterator newIterator(
        String id, SlotIterator.Type type, int startRow, int startColumn) {
    ...
    public InventoryContents fillRect(SlotPos fromPos, SlotPos toPos, ClickableItem item) {
      return fillRect(
          fromPos.getRow(), fromPos.getColumn(), toPos.getRow(), toPos.getColumn(), item);
    }
    ...
    private void update(int row, int column, ItemStack item) {
      ...
      if (!inv.getManager().getOpenedPlayers(inv).contains(currentPlayer)) return;
